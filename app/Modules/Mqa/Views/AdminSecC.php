<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="container container-main">
        <h4 class="header-title">ADMIN: SECTION C</h4>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php foreach ($section->items as $index => $item): ?>
                            <?php if ($item->mcd_programme_code !== $selectedProgrammeCode) continue; ?>
                            <tr>
                                <td><?= $index + 1 ?>.</td>
        ...
        <div class="nav-buttons">
            ...
            <a href="<?= base_url('AdminSecB.php?section=B') ?>" class="btn btn-primary nav-btn">
                <i class="fas fa-arrow-right me-2"></i>Go to Section B
            </a>
